...
def main():
    ...
    if not os.path.exists(os.path.join(path, "trainx")):
        raise FileNotFoundError(f"Training images directory not found: {os.path.join(path, 'trainx')}")
    if not os.path.exists(os.path.join(path, "trainy")):
        raise FileNotFoundError(f"Training masks directory not found: {os.path.join(path, 'trainy')}")
    if not os.path.exists(os.path.join(path, "validationx")):
        raise FileNotFoundError(f"Validation images directory not found: {os.path.join(path, 'validationx')}")
    if not os.path.exists(os.path.join(path, "validationy")):
        raise FileNotFoundError(f"Validation masks directory not found: {os.path.join(path, 'validationy')}")
    if not os.path.exists(os.path.join(path, "testx")):
        raise FileNotFoundError(f"Test images directory not found: {os.path.join(path, 'testx')}")
    if not os.path.exists(os.path.join(path, "testy")):
        raise FileNotFoundError(f"Test masks directory not found: {os.path.join(path, 'testy')}")
